...
public class frmResidenciales extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "RESIDENCIALES REGISTRADOS", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 14), new java.awt.Color(255, 255, 255))); // NOI18N
    ...
    private void cargarTabla() {
        try {
            ArrayList<TipoVivienda> ltsTipoVivienda = TipoViviendaBo.obtenerResidencial();
    ...
    private void buscar() {
        ...
        try {
            ltsTipoVivienda = TipoViviendaBo.buscarTipoViviendaResidencial(buscar);
            MTTV.setListado_TipoVivienda(ltsTipoVivienda);
        } catch (Exception e) {
            System.out.println(e.getMessage());
        }
    ...
    private void eliminar() {
        if (this.tablaComercial.getSelectedRow() != -1) {
            ...
            if (objTV.getEstado().equals("Si")) {
                int confirm = JOptionPane.showConfirmDialog(this, "¿Está seguro que desea eliminar el RESIDENCIAL "
                        + objTV.toString() + " ?", "ELIMINAR RESIDENCIAL", JOptionPane.YES_NO_OPTION);
                if (confirm == 0) {
                    try {
                        if (TipoViviendaBo.eliminarTipVivienda(objTV)) {
                            ...
                            JOptionPane.showMessageDialog(this, "No se pudo Eliminar", "MENSAJE --> RESIDENCIAL", JOptionPane.ERROR_MESSAGE);
                        }
                    } catch (Exception e) {
                        System.out.println(e.getMessage());
                    }
                ...
                JOptionPane.showMessageDialog(this, "El tipo de Vivienda selecionado ya se encuentra Inactivo.", "MENSAJE --> RESIDENCIAL", JOptionPane.ERROR_MESSAGE);
            }
        } else {
            JOptionPane.showMessageDialog(this, "Usted no a seleccionado un campo en la tabla.", "MENSAJE --> RESIDENCIAL", JOptionPane.ERROR_MESSAGE);
        }
    }
    ...
    private void guardar() {
        if (this.general()) {
            TipoVivienda objTipViv = new TipoVivienda(0, this.txtNombre.getText(), 1, Double.parseDouble(this.txtImpAgua.getText()),
                ...
                if (this.objC == null) {
                    if (TipoViviendaBo.buscarDescripcion(objTipViv.getDescripcion())) {
                        if (TipoViviendaBo.grabarTipVivienda(objTipViv)) {
                            JOptionPane.showMessageDialog(this, "Se Registró Correctamente", "MENSAJE --> RESIDENCIAL", JOptionPane.INFORMATION_MESSAGE);
                        } else {
                            JOptionPane.showMessageDialog(this, "No se pudo Registrar", "MENSAJE --> RESIDENCIAL", JOptionPane.ERROR_MESSAGE);
                        }
                    } else {
                        JOptionPane.showMessageDialog(this, "La Descripción ingresada ya se encuentra registrada.", "MENSAJE --> RESIDENCIAL", JOptionPane.WARNING_MESSAGE);
                    }
                } else {
                    ...
                    if (existe) {
                        if (TipoViviendaBo.modificarTipVivienda(objTipViv)) {
                            JOptionPane.showMessageDialog(this, "Se Modificó Correctamente", "MENSAJE --> RESIDENCIAL", JOptionPane.INFORMATION_MESSAGE);
                        } else {
                            JOptionPane.showMessageDialog(this, "No se pudo Modificar", "MENSAJE --> RESIDENCIAL", JOptionPane.ERROR_MESSAGE);
                        }
                    } else {
                        JOptionPane.showMessageDialog(this, "La Descripción ingresada ya se encuentra registrada.", "MENSAJE --> RESIDENCIAL", JOptionPane.WARNING_MESSAGE);
                    }
            ...
            JOptionPane.showMessageDialog(this, "Verifique que todos los campos hallan sido llenados correctamente.", "MENSAJE --> RESIDENCIAL", JOptionPane.WARNING_MESSAGE);
        }
    }
