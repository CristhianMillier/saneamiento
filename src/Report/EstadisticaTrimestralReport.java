...
public class EstadisticaTrimestralReport {
    ...
    public void verReporte(int mes, int anio) throws Exception {
        ...
        try {
            String path = "src\\Report\\ReportEstaditicoTrimestral.jasper";
            ...
            view.setTitle("Reporte de Estadístico de Ingresos Trimestales a partir del mes " + months[mes - 1] + " del año " + anio);
