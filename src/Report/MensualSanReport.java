...
public class MensualSanReport {

    public void verReporte(double totalPago, int mes, int anio) throws Exception {
        JasperReport repor;
        JasperPrint re;
        JasperViewer view;
        ...
        try {
            String path = "src\\Report\\ReportMensualSan.jasper";
            ...
            view.setTitle("Reporte de Ingresos Mensual del mes " + months[mes - 1] + " del año " + anio);
